...
public class FVM : MonoBehaviour
{
    ...
    void _Update()
    {
    	...
    	for(int tet = 0; tet < tet_number; tet++)
    	{
    		...
    		//TODO: Green Strain
			Matrix4x4 G = Dot_Number(0.5f, Get_Matrix_Sum(F.transpose * F, Get_Negative(Matrix4x4.identity)));
			G[3, 3] = 1;

    		//TODO: Second PK Stress
			Matrix4x4 S = Get_Matrix_Sum(Dot_Number(stiffness_0 * Trace(G), Matrix4x4.identity), Dot_Number(2 * stiffness_1, G));
			S[3, 3] = 1;
			Matrix4x4 P = F * S;
			P[3, 3] = 1;
